      ...
      <Card className="shadow-2xl border-0 backdrop-blur-sm bg-white/90">
        ...
        <CardContent className="p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Ник в телеграмм */}
            <div className="space-y-3">
              <Label htmlFor="telegramNick" className="text-lg font-semibold text-gray-700">
                Ник в телеграмм
              </Label>
              <Input
                id="telegramNick"
            ...
            <div className="bg-gradient-to-r from-violet-50 to-purple-50 border-2 border-violet-200 rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="text-sm">
                  <p className="font-semibold mb-3 text-violet-800 text-lg">Важная информация:</p>
            ...
            {/* Комментарий */}
            <div className="space-y-3">
              <Label htmlFor="comment" className="text-lg font-semibold text-gray-700">
                Дополнительные пожелания <span className="text-gray-400 font-normal">(необязательно)</span>
              </Label>
              <Textarea
                id="comment"
