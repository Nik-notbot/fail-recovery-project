...
export default function BybitModal({ isOpen, onClose }: BybitModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 flex flex-col border-4 border-transparent bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 p-1 shadow-2xl">
