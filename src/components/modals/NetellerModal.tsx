...
export default function NetellerModal({ isOpen, onClose }: NetellerModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 flex flex-col border-4 border-transparent bg-gradient-to-br from-green-400 via-teal-500 to-blue-500 p-1 shadow-2xl">
