...
export default function WiseModal({ isOpen, onClose }: WiseModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 flex flex-col border-4 border-transparent bg-gradient-to-br from-blue-400 via-purple-500 to-indigo-500 p-1 shadow-2xl">
