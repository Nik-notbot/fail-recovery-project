...
export default function EsimModal({ isOpen, onClose }: EsimModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 flex flex-col border-4 border-transparent bg-gradient-to-br from-blue-400 via-cyan-500 to-teal-500 p-1 shadow-2xl">
